                              ...
                              <div className="flow-root flex-1">
                                ...
                                >
                                  <DesktopComputerIcon
                                    ...
                                    aria-hidden="true"
                                  />
                                  <span className="ml-3">{t('Free trial')}</span>
                                </a>
                              </div>
                              <div className="flow-root flex-1">
                                <div
                                  className="-m-3 flex cursor-pointer items-center rounded-md p-3 text-base font-medium text-gray-900 hover:bg-gray-100"
                                  rel="noreferrer"
                                ...
                                >
                                  <ChatIcon
                                    ...
                                    aria-hidden="true"
                                  />
                                  <span className="ml-3">{t('Consulting Sales')}</span>
                                </div>
                              </div>
                            </div>
                          </div>
